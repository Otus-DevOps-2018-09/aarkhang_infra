...
Домашнее задание #11    Ansible-4
----------------------------------
### Что сделано
1. На локальном ПК при помощи Vagrant создана инфраструктура из двух ВМ VirtualBox.
2. В Vagrantfile добавлен провижининг хостов при помощи плейбуков Ansible.
3. Добавлен плейбук для установки python на хосты.
4. Роль db доработана для возможности установки MongoDB.
5. Роль app доработана для возможности установки ruby и rubygems.
6. Параметризована роль app для возможности работы с пользователем, отличным от appuser.
7. Дополнены переменные extra_vars в Vagrantfile для работы nginx-прокси.
8. Проверено создание виртуалок и работа приложения.
9. Доработаны плейбуки и шаблоны packer для использования ролей app и db.
10. Для роли db описаны тесты с помощью molecule и Testinfra, в том числе тест доступности порта БД (27017).
11. Роль db вынесена в отдельный репозиторий [aarkhang/test-ansible-role](https://github.com/aarkhang/test-ansible-role).
12. Отлажены сценарии тестирования роли локально с помощью Vagrant и Docker.
13. Отлажен сценарий тестирования роли в облаке GCP.
14. Для репозитория роли подключены тесты TravisCI
15. Настроено оповещения о статусе билда роли в [Slack-чат](https://devops-team-otus.slack.com/messages/CDAQ5UBNH/ ).
